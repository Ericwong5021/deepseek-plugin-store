window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var Store_module_css_default = {
			...
			"frame": "WDA15W_frame",
			"installing": "WDA15W_installing",
			"rail": "WDA15W_rail",
			"entry": "WDA15W_entry",
			"page": "WDA15W_page",
			"connectionNote": "WDA15W_connectionNote"
		};
		//#endregion
			...
			return (0, react_jsx_runtime.jsx)("main", {
				...
				children: (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						!connected && (0, react_jsx_runtime.jsx)("div", {
							className: Store_module_css_default.connectionNote,
							role: "status",
							children: "连接 DSH 会话后可直接安装插件"
						}),
