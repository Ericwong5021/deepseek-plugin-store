window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0plugin-store-css:/Users/wangyidong/project/deepseek-plugin-store/lib/types/client/Store.module.css.mjs
		const css = ".tcN71G_entry{flex:0 0 100%;width:100%;min-width:0;height:49px;margin-top:8px;display:flex}.tcN71G_trigger{width:100%;min-height:40px;color:var(--dsw-alias-label-primary);font:var(--dsw-font-s-14);cursor:pointer;touch-action:manipulation;transition:background var(--ds-transition-duration-fast) var(--ds-ease-in-out), transform var(--ds-transition-duration-fast) var(--ds-ease-in-out);background:0 0;border:0;border-radius:12px;align-items:center;gap:8px;padding:0 8px 0 6px;display:flex}.tcN71G_trigger:hover{background:var(--dsw-alias-interactive-bg-hover)}.tcN71G_triggerActive{background:var(--dsw-specific-sidebar-nav-item-active,var(--dsw-alias-interactive-bg-active));color:var(--dsw-alias-brand-primary)}.tcN71G_trigger:active{transform:scale(.96)}.tcN71G_trigger:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:2px}.tcN71G_rail{flex:0 0 36px;width:36px;height:36px;margin:0}.tcN71G_rail .tcN71G_trigger{border-radius:50%;justify-content:center;width:36px;height:36px;min-height:36px;padding:0}.tcN71G_page{background:var(--dsw-alias-bg-base);width:100%;min-width:0;height:100%;min-height:0;color:var(--dsw-alias-label-primary);font-family:var(--dsw-font-family);flex:1;grid-template-rows:minmax(0,1fr);display:grid;overflow:hidden}.tcN71G_frameWrap{background:#fff;min-width:0;min-height:0;position:relative;overflow:hidden}.tcN71G_frame{background:#fff;border:0;width:100%;height:100%;display:block}";
		...
		var Store_module_css_default = {
			"entry": "tcN71G_entry",
			"triggerActive": "tcN71G_triggerActive",
			"page": "tcN71G_page",
			"trigger": "tcN71G_trigger",
			"frameWrap": "tcN71G_frameWrap",
			"frame": "tcN71G_frame",
			"rail": "tcN71G_rail"
		};
		//#endregion
		...
		function StoreTrigger({ wide, useSessions, openSession, installPlugins }) {
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				}), open && pageHost !== null && (0, react_dom.createPortal)((0, react_jsx_runtime.jsx)(StorePage, { installPlugins }), pageHost)]
			});
		}
		function StorePage({ installPlugins }) {
