...
[![Verified Plugins](https://img.shields.io/badge/verified_plugins-346-c9362b?style=flat-square)](#all-verified-plugins)
...
> **346 verified plugins** · **276 related projects** · Updated hourly · Last sync: 2026-08-13 20:03 UTC
...
| | Category | Plugins |
|:--:|:--|--:|
| 🎨 | [UI Enhancements](#ui-enhancements) | 98 |
| 🔁 | [Workflow & Automation](#workflow-automation) | 38 |
| 🛠️ | [Tools](#tools) | 68 |
...
|--:|:--|:--|--:|
| 1 | [liustack/modlens](https://github.com/liustack/modlens) | Miscellaneous | ★697 |
| 2 | [ccch1mneyyy/dsh-cc-tui](https://github.com/ccch1mneyyy/dsh-cc-tui) | Tools | ★193 |
| 3 | [Anionex/dsh-vision-toolkit](https://github.com/Anionex/dsh-vision-toolkit) | UI Enhancements | ★145 |
| 4 | [omdsh-dev/DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | UI Enhancements | ★125 |
| 5 | [Nagi-ovo/dsh-ads](https://github.com/Nagi-ovo/dsh-ads) | UI Enhancements | ★104 |
...
<details>
<summary><strong>🎨 UI Enhancements</strong> <sup>98 plugins</sup></summary>
...
- [omdsh-dev/DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) ★125 · `dsh-better-sidebar` — 一个侧边栏的完整工作台，支持三方拓展注册新Tab页面，内置文件渲染编辑/终端/Git/子代理
- [Nagi-ovo/dsh-ads](https://github.com/Nagi-ovo/dsh-ads) ★104 · `@dsh-external/dsh-ads` — 是兄弟就来蹬我！DSH Web UI 广告：2005 年中文站点风格的侧栏广告 / 对话内信息流 / 角落弹窗 + 一个真实热区比视觉小得多的关闭叉。素材全虚构，域名打码。
...
- [loudMore/dsh-drop-to-path](https://github.com/loudMore/dsh-drop-to-path) ★0 · `@dsh-external/dsh-drop-to-path` — 解决纯文本模型发图被拒的问题:「当前模型不支持图片,请切换支持图片的模型」。保留原生附件体验,发送时自动把图片转为工作区路径,配合 dsh-vision-toolkit 实现粘贴即看图。Fixes the "The current model does not support images" rejection: keeps the native attachment UI but sends images to a text-only model as workspace file paths, pairing with dsh-vision-toolkit.
...
- [MC5lan/dsh-multimodal](https://github.com/MC5lan/dsh-multimodal) ★0 · `dsh-multimodal` — 给 DeepSeek 安装一双眼睛和一支画笔:会话里直接贴截图/图片,GLM 视觉模型先精确转写图片内容(报错信息、代码、界面逐字保留),然后 DeepSeek 继续处理你的问题——同一轮完成,全程无感;需要配图时,DeepSeek 自动调用文生图后端出图并显示在会话中。
...
<details>
<summary><strong>🔁 Workflow & Automation</strong> <sup>38 plugins</sup></summary>
...
<a id="tools"></a>
<details>
<summary><strong>🛠️ Tools</strong> <sup>68 plugins</sup></summary>

### Tools

- [ccch1mneyyy/dsh-cc-tui](https://github.com/ccch1mneyyy/dsh-cc-tui) ★193 · `dsh-cc-tui` — DSH 官方尚无终端 TUI 的补位之作：Claude Code 风格全屏交互终端插件——像素鲸鱼顶栏、实时工作状态行、思考流式展开、双击 Esc 回滚、上下文进度条 + TPS 仪表。npm 一键安装。
...
- [omdsh-dev/dsh-notification](https://github.com/omdsh-dev/dsh-notification) ★24 · `dsh-notification` — Desktop notifications for DeepSeek Harness turn completions, with per-outcome controls and include/exclude keyword rules.
...
- [liustack/modlens](https://github.com/liustack/modlens) ★697 · `@liustack/modlens` — The first vision plugin for DeepSeek Harness, and the vision bridge for every text-only coding agent. Paste an image, get structured JSON evidence (OCR, layout, semantics).
...
- [XiLuovo/dsh-session-timeline](https://github.com/XiLuovo/dsh-session-timeline) ★1 · `dsh-session-timeline` — DeepSeek Harness 会话时间轴插件：横短横线波浪、当前消息定位、点击跳转、圆角预览 tooltip、可收起/展开
...
<details>
<summary><strong>Browse 276 related projects</strong></summary>

- [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) ★37601 — DeepSeek Harness: Everything is a Plugin.
- [titanwings/colleague-skill](https://github.com/titanwings/colleague-skill) ★21048 — 将冰冷的离别化为温暖的 Skill，欢迎加入数字生命1.0！Transforming cold farewells into warm skills? It's giving rebirth era. Welcome to Digital Life 1.0. 🫶
- [Devin-AXIS/iPolloWork](https://github.com/Devin-AXIS/iPolloWork) ★3543 — A next-generation, source-available AI workspace with a self-evolving agent runtime for editable code, design, presentations, websites, and video—a Codex alternative that integrates DeepSeek Harness for subagent delegation, combining iPolloWork’s complete AI workbench with DSH’s specialized agents and both plugin ecosystems in one workflow.
- [whiteguo233/OpenBiliClaw](https://github.com/whiteguo233/OpenBiliClaw) ★1920 — 本地私有、开源的跨平台 AI 内容发现 Agent：先理解你，再主动从 B站、小红书、抖音、YouTube、X、知乎、Reddit、微博等平台与开放 Web 寻找内容。 | Local-first open-source cross-platform AI content discovery agent: understands you, then proactively finds content across Bilibili, Xiaohongshu, Douyin, YouTube, X, Zhihu, Reddit, Weibo and the open web.
...
- [zhu1090093659/dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) ★495 — Plugin and skin collection for DeepSeek Harness (DSH) Web UI - task board, git graph, right-side panel, remote mobile UI, pet, live token stats, and skin center.
- [AdamPlatin123/awesome-dsh-plugins](https://github.com/AdamPlatin123/awesome-dsh-plugins) ★291 — ✨ Awesome DSH Plugins — DeepSeek Harness plugin directory with daily compatibility tracking ｜ DeepSeek Harness 插件生态目录与每日兼容性追踪
...
- [morluto/rea](https://github.com/morluto/rea) ★188 — Reverse engineer anything with agents, from app behavior down to native binaries.
- [0xsline/awesome-deepseek-harness](https://github.com/0xsline/awesome-deepseek-harness) ★133 — DeepSeek Harness (DSH) ecosystem: curated plugins, tools, and infrastructure from dsh-external/hub and the public dsh-plugin topic.
- [Small-tailqwq/dsh-deep-whale](https://github.com/Small-tailqwq/dsh-deep-whale) ★115 — DSH Web 鲸鱼娘皮肤系列(深海女仆工坊 maid-atelier)——CC BY-NC-SA 4.0
- [awesome-dsh-plugin/awesome-dsh-plugin](https://github.com/awesome-dsh-plugin/awesome-dsh-plugin) ★100 — A curated list of plugins for DeepSeek Harness (dsh) · DeepSeek Harness 插件精选列表
- [pulseaiclub/phi](https://github.com/pulseaiclub/phi) ★71 — a coding Agent from pi. sub-agents, hashline edits, and a permission gate
...
- [Ruler4396/dsh-launcher](https://github.com/Ruler4396/dsh-launcher) ★20 — Lightweight Windows launcher for DeepSeek Harness: silent autostart at logon + a minimal WebView2 window instead of a full browser
- [bruc3van/awesome-dsh-plugin](https://github.com/bruc3van/awesome-dsh-plugin) ★19 — 用 30 秒找到适合你的 DeepSeek Harness 插件。 不只是仓库列表：这里告诉你插件解决什么问题、适合谁，以及从哪里开始。
...
- [ysr666/dsh-vision-router](https://github.com/ysr666/dsh-vision-router) ★3 — DeepSeek Harness plugin: turn-level vision routing with provider fallback chains, a cached vision_describe tool with JSON output and image downscaling, and optional per-host proxy support.
...
- [unnnnoooo/dsh-cue-plugin](https://github.com/unnnnoooo/dsh-cue-plugin) ★1 — DeepSeek Harness 的跨会话引用(cue)插件
...
- [csiroqa/dsh-plugin-usage-report](https://github.com/csiroqa/dsh-plugin-usage-report) ★0 — DeepSeek Harness usage-report plugin: daily/monthly token & cost aggregation, budget alerts, Claude Code/Codex-style contribution grid and fun stats
...
- [boNeXY226/dsh-command-cost](https://github.com/boNeXY226/dsh-command-cost) ★0 — dsh profile plugin: /cost command + floating web UI cost chip with peak/off-peak time-of-day pricing
