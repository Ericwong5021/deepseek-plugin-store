...
> **325 verified plugins** · **263 related projects** · Updated hourly · Last sync: 2026-08-13 19:14 UTC
...
| | Category | Plugins |
|:--:|:--|--:|
| 🎨 | [UI Enhancements](#ui-enhancements) | 90 |
| 🔁 | [Workflow & Automation](#workflow-automation) | 36 |
| 🛠️ | [Tools](#tools) | 65 |
| 🔔 | [Notifications & Monitoring](#notifications) | 8 |
| 🧑‍💻 | [Development Helpers](#dev-helpers) | 9 |
| 🎓 | [Learning & Education](#learning) | 1 |
| 🧩 | [Miscellaneous](#misc) | 116 |
...
|--:|:--|:--|--:|
| 1 | [liustack/modlens](https://github.com/liustack/modlens) | Miscellaneous | ★691 |
| 2 | [ccch1mneyyy/dsh-cc-tui](https://github.com/ccch1mneyyy/dsh-cc-tui) | Tools | ★190 |
| 3 | [Anionex/dsh-vision-toolkit](https://github.com/Anionex/dsh-vision-toolkit) | UI Enhancements | ★143 |
| 4 | [omdsh-dev/DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | UI Enhancements | ★122 |
| 5 | [Nagi-ovo/dsh-ads](https://github.com/Nagi-ovo/dsh-ads) | UI Enhancements | ★100 |
...
<details>
<summary><strong>🎨 UI Enhancements</strong> <sup>90 plugins</sup></summary>
...
- [Nagi-ovo/dsh-ads](https://github.com/Nagi-ovo/dsh-ads) ★100 · `@dsh-external/dsh-ads` — 是兄弟就来蹬我！DSH Web UI 广告：2005 年中文站点风格的侧栏广告 / 对话内信息流 / 角落弹窗 + 一个真实热区比视觉小得多的关闭叉。素材全虚构，域名打码。
...
<details>
<summary><strong>🔁 Workflow & Automation</strong> <sup>36 plugins</sup></summary>
...
<a id="tools"></a>
<details>
<summary><strong>🛠️ Tools</strong> <sup>65 plugins</sup></summary>
...
<a id="dev-helpers"></a>
<details>
<summary><strong>🧑‍💻 Development Helpers</strong> <sup>9 plugins</sup></summary>
...
<a id="misc"></a>
<details>
<summary><strong>🧩 Miscellaneous</strong> <sup>116 plugins</sup></summary>
...
- [PivotStackIntelligence/dsh-github](https://github.com/PivotStackIntelligence/dsh-github) ★1 · `dsh-github` — VS Code-inspired Source Control and GitHub panel for DeepSeek Harness.
...
- [Amengclass/dsh-todo](https://github.com/Amengclass/dsh-todo) ★0 · `dsh-todo` — A small task/todo board plugin for DeepSeek Harness (dsh-plugin). Adds todo_add/todo_list/todo_check/todo_uncheck/todo_remove/todo_stats tools with optional JSONL persistence.
...
<details>
<summary><strong>Browse 263 related projects</strong></summary>
...
- [Anionex/agent-vision-toolkit](https://github.com/Anionex/agent-vision-toolkit) ★512 — 为纯文本模型"看图“设计更好的视觉工具箱和技能，支持多图理解，图片问答，前端UI还原、GUI 自动化等，并可选无缝接入多个主流agent，直接识别粘贴图片｜ A vision toolkit and skill designed for text-only llms — image Q&A, long-screenshot OCR, frontend UI restoration, and GUI automation, with optional seamless integration for Codex, Claude Code, Pi, Oh My Pi, and OpenCode
- [zhu1090093659/dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) ★482 — Plugin and skin collection for DeepSeek Harness (DSH) Web UI - task board, git graph, right-side panel, remote mobile UI, pet, live token stats, and skin center.
...
- [AdamPlatin123/awesome-dsh-plugins](https://github.com/AdamPlatin123/awesome-dsh-plugins) ★283 — ✨ Awesome DSH Plugins — DeepSeek Harness plugin directory with daily compatibility tracking ｜ DeepSeek Harness 插件生态目录与每日兼容性追踪
...
- [morluto/rea](https://github.com/morluto/rea) ★182 — Reverse engineer anything with agents, from app behavior down to native binaries.
- [0xsline/awesome-deepseek-harness](https://github.com/0xsline/awesome-deepseek-harness) ★130 — DeepSeek Harness (DSH) ecosystem: curated plugins, tools, and infrastructure from dsh-external/hub and the public dsh-plugin topic.
- [Small-tailqwq/dsh-deep-whale](https://github.com/Small-tailqwq/dsh-deep-whale) ★111 — DSH Web 鲸鱼娘皮肤系列(深海女仆工坊 maid-atelier)——CC BY-NC-SA 4.0
- [awesome-dsh-plugin/awesome-dsh-plugin](https://github.com/awesome-dsh-plugin/awesome-dsh-plugin) ★94 — A curated list of plugins for DeepSeek Harness (dsh) · DeepSeek Harness 插件精选列表
...
- [LaplaceYoung/oh-my-dsh](https://github.com/LaplaceYoung/oh-my-dsh) ★22 — oh-my-dsh：面向 DSH (DeepSeek Harness) 的插件生态——700+ 插件，只通过扩展接缝注册，不修改 agent-loop 骨架
...
- [Ruler4396/dsh-launcher](https://github.com/Ruler4396/dsh-launcher) ★18 — Lightweight Windows launcher for DeepSeek Harness: silent autostart at logon + a minimal WebView2 window instead of a full browser
...
- [vlln/plugin-registry](https://github.com/vlln/plugin-registry) ★11 — DSH 插件生态基建：薄控制台（浏览器面板管理官方 repository 插件，0 patch）+ make-dsh-plugin skill 官方插件开发引导
...
- [PerryLink/dsh-github](https://github.com/PerryLink/dsh-github) ★0 — GitHub integration for DeepSeek Harness: create PRs, review PRs in background jobs, read issues - every write gated by human approval
