...
export default [
  {
    ...
    DESC: 'An open source directory of {N} GitHub repositories carrying the dsh-plugin topic. Updated hourly.',
    SEARCH_PH: 'Search plugins…',
    CAT_TITLE: '{CAT} — DeepSeek Plugin Store',
    CAT_DESC: '{N} {CAT} repositories carrying the dsh-plugin topic. Install commands, descriptions, and links — updated hourly.',
    ...
    strings: {
      ...
      TAGLINE: 'Every GitHub repository carrying the <code translate="no">dsh-plugin</code> topic.',
      LISTING_PRE: 'Listing',
      ...
      CONTRIB_BODY: 'Add the <a href="https://github.com/topics/dsh-plugin" rel="noopener"><code translate="no">dsh-plugin</code></a> topic to your repository; the scheduled crawl will sync it automatically.',
  ...
  },
  {
    ...
    DESC: '自动收录带有 dsh-plugin Topic 的 {N} 个 GitHub 仓库，每小时更新。',
    SEARCH_PH: '搜索插件…',
    CAT_TITLE: '{CAT} — DeepSeek Plugin Store · DeepSeek Harness 插件数据源',
    CAT_DESC: '带有 dsh-plugin Topic 的 {CAT}仓库，共 {N} 个：含安装命令、功能描述与仓库链接，每小时更新。',
    COPY_LABEL: '复制安装命令',
    COPY_TEXT: '复制安装命令',
    categories: {
    ...
    strings: {
      SKIP: '跳到插件列表',
      TAGLINE: '自动收录所有带有 <code translate="no">dsh-plugin</code> Topic 的 GitHub 仓库。',
      LISTING_PRE: '收录',
      LISTING_POST: '个插件',
      ...
      CONTRIB: '收录你的插件',
      CONTRIB_BODY: '给你的仓库添加 <a href="https://github.com/topics/dsh-plugin" rel="noopener"><code translate="no">dsh-plugin</code></a> Topic，定时抓取会自动同步。',
      MOTTO: '探索未至之境',
