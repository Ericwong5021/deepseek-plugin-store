...
[![Topic Plugins](https://img.shields.io/badge/topic_plugins-998-c9362b?style=flat-square)](#all-topic-plugins)
...
> **998 plugin repositories** · Updated hourly · Last sync: 2026-08-14 07:11 UTC
...
- [All plugin repositories](#all-topic-plugins)
...
| | Category | Plugins |
|:--:|:--|--:|
| 🎨 | [UI Enhancements](#ui-enhancements) | 266 |
| 🔁 | [Workflow & Automation](#workflow-automation) | 109 |
| 🛠️ | [Tools](#tools) | 156 |
| 🔔 | [Notifications & Monitoring](#notifications) | 23 |
| 🧑‍💻 | [Development Helpers](#dev-helpers) | 48 |
| 🎓 | [Learning & Education](#learning) | 5 |
| 🧩 | [Miscellaneous](#misc) | 391 |
...
|--:|:--|:--|--:|
| 1 | [nexu-io/open-design](https://github.com/nexu-io/open-design) | UI Enhancements | ★85701 |
| 2 | [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | Miscellaneous | ★75885 |
| 3 | [titanwings/colleague-skill](https://github.com/titanwings/colleague-skill) | Miscellaneous | ★21651 |
| 4 | [Devin-AXIS/iPolloWork](https://github.com/Devin-AXIS/iPolloWork) | Workflow & Automation | ★3788 |
| 5 | [whiteguo233/OpenBiliClaw](https://github.com/whiteguo233/OpenBiliClaw) | Miscellaneous | ★2193 |
...
<details>
<summary><strong>🎨 UI Enhancements</strong> <sup>266 plugins</sup></summary>

### UI Enhancements

- [nexu-io/open-design](https://github.com/nexu-io/open-design) ★85701 · `open-design` — 🎨 The open-source Claude Design alternative. 🖥️ Local-first desktop app. 🖼️ Your coding agent becomes the design engine: prototypes, landing pages, dashboards, slides, images & video — real files, HTML/PDF/PPTX/MP4 export. 🤖 Claude Code / Codex / Cursor / Gemini / OpenCode / Qwen & 20+ CLIs via BYOK.
- [zhu1090093659/dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) ★1174 · `dsh-web-ui` — Plugin and skin collection for DeepSeek Harness (DSH) Web UI - task board, git graph, right-side panel, remote mobile UI, pet, live token stats, and skin center.
- [Anionex/agent-vision-toolkit](https://github.com/Anionex/agent-vision-toolkit) ★722 — 为纯文本模型"看图“设计更好的视觉工具箱和技能，支持多图理解，图片问答，前端UI还原、GUI 自动化等，并可选无缝接入多个主流agent，直接识别粘贴图片｜ A vision toolkit and skill designed for text-only llms — image Q&A, long-screenshot OCR, frontend UI restoration, and GUI automation, with optional seamless integration for Codex, Claude Code, Pi, Oh My Pi, and OpenCode
- [omdsh-dev/DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) ★493 · `dsh-better-sidebar` — 一个侧边栏的完整工作台，支持三方拓展注册新Tab页面，内置文件渲染编辑/终端/Git/子代理
- [alaliqing/claude-paper](https://github.com/alaliqing/claude-paper) ★289 — 📚 Claude Code plugin that automates research papers study with automatic material generation, code demonstrations, and interactive web viewer.
- [Anionex/dsh-vision-toolkit](https://github.com/Anionex/dsh-vision-toolkit) ★258 · `@dsh-external/dsh-vision-toolkit` — 让纯文本模型更好地做视觉任务的DeepSeek Harness插件：带意图的图片问答、长截图 OCR、UI 还原等｜DeepSeek Harness-native integration for agent-vision-toolkit: image Q&A, long-screenshot OCR, UI restoration, grounding, pixel diff, Artifacts, and Web UI.
- [Nagi-ovo/dsh-ads](https://github.com/Nagi-ovo/dsh-ads) ★249 · `@dsh-external/dsh-ads` — 是兄弟就来蹬我！DSH Web UI 广告：2005 年中文站点风格的侧栏广告 / 对话内信息流 / 角落弹窗 + 一个真实热区比视觉小得多的关闭叉。素材全虚构，域名打码。
...
- [hust-open-atom-club/oh-dsh](https://github.com/hust-open-atom-club/oh-dsh) ★124 · `@oh-dsh/desktop` — 一站式 DeepSeek Harness 社区发行版：TUI、桌面端与 Web UI 三种形态统一体验，支持分层安装、一步到位，免去手工整合打包。
- [huiliyi37/dsh-tianshu-tui](https://github.com/huiliyi37/dsh-tianshu-tui) ★101 · `@huiliyi37/dsh-tianshu-tui` — dsh-tianshu-tui — DeepSeek Harness terminal UI +harness workflow。是官方 DeepSeek Harness 上的交互式终端 UI 插件。渲染核心从本仓库自研的harness agent  Tianshu-Tui 演进而来，在官方的基础上增加了TDD与证据门等工作流。
- [Nagi-ovo/dsh-visualize](https://github.com/Nagi-ovo/dsh-visualize) ★59 · `@dsh-external/dsh-visualize` — DSH 对话内生成式 UI 插件：模型把交互式 HTML 卡片直接画进会话流——visualize 工具 + 配套 skill + 沙箱渲染卡，带流式预览、组件浮入动画与鲸鱼蓝主题跟随
...
- [alingalingling/ui-status-label](https://github.com/alingalingling/ui-status-label) ★25 · `dsh-ui-status-label` — 把你鲸鱼娘思考时的 deep diving 自定义成任意你想要的样子
...
- [whiteguo233/dsh-openbiliclaw](https://github.com/whiteguo233/dsh-openbiliclaw) ★17 · `@openbiliclaw/dsh-plugin` — OpenBiliClaw 是本地运行的跨平台个性化内容推荐 Agent，持续理解你的兴趣并主动找内容。本仓库是它的 DeepSeek Harness 插件：DSH 界面常驻第四栏（推荐/内容库/对话/画像/设置），注册 22 个 Agent Bridge 工具，让 Agent 也能读推荐、答探测、闭环学习。
- [huiliyi37/dsh-tianshu-build](https://github.com/huiliyi37/dsh-tianshu-build) ★17 · `@huiliyi37/dsh-tianshu-root` — dsh-tianshu-tui — DeepSeek Harness terminal UI
- [ChisaAlter/Deepseek-Harness-Desktop](https://github.com/ChisaAlter/Deepseek-Harness-Desktop) ★17 · `deepseek-harness-desktop` — DSH桌面端，支持主题和背景图等多种个性化配置。Electron desktop shell for DeepSeek Harness web UI
- [william-jin-cmu/dsh-vision](https://github.com/william-jin-cmu/dsh-vision) ★15 · `@dsh-external/dsh-vision` — dsh 插件：给纯文本 DeepSeek 加视觉——view_image 工具桥接任意 OpenAI 兼容 VLM（默认智谱免费档，实测 4 厂商 10 模型）
- [ccq1/dsh-side-panel](https://github.com/ccq1/dsh-side-panel) ★14 · `@dsh-external/dsh-side-panel` — DSH 侧边栏，集成文件浏览器、终端和 Git 审查，方便预览文件。
- [JustGenius-s/DSH-Desktop](https://github.com/JustGenius-s/DSH-Desktop) ★14 · `dsh-desktop` — DSH-Desktop
- [bruc3van/dsh-desktop](https://github.com/bruc3van/dsh-desktop) ★13 · `dsh-desktop` — DeepSeek Harness Desktop 是一款第三方桌面客户端，通过直接加载官方 Web UI，为普通用户提供开箱即用的独立桌面体验：它可以自动复用本机已运行的官方实例，也可以使用安装包内置的 dsh 运行时启动服务，无需用户额外安装 Node.js 或 CLI，并提供智能连接、远程实例连接、托盘常驻、运行时监护和异常恢复等桌面增强。
- [Nwflower/dsh-chat-import](https://github.com/Nwflower/dsh-chat-import) ★12 · `dsh-chat-import` — 从Claude Code、Codex、Reasonix等Agent工具导入历史消息，并在DSH中继续对话
...
- [dingyi222666/dsh-focus-chat](https://github.com/dingyi222666/dsh-focus-chat) ★10 · `@dingyi222666/dsh-focus-chat` — 为 dsh 提供新的「聚焦会话」精简会话视图，更轻松易于阅读，只关注最终产出结果。
...
- [CanglongCl/dsh-web-review](https://github.com/CanglongCl/dsh-web-review) ★10 · `dsh-web-review` — DeepSeek Harness Web GUI 的网页预览与元素批注插件，让 AI 根据可视化反馈直接修改前端源码。
...
- [dancingmemory/dskin](https://github.com/dancingmemory/dskin) ★8 · `dskin` — DSKIN · DeepSeek Harness（DSH）卡通像素皮肤插件 / Cartoon pixel skin plugin for DSH Web GUI — 原始界面不动，像素宠物会散步、眨眼、跳跃 / living pixel pets that stroll, blink and hop
...
- [ayuanwong/deepseek-harness-ux](https://github.com/ayuanwong/deepseek-harness-ux) ★5 · `@deepseek-ai/dsh-root` — 长任务，不刷屏：关键进度清晰可见，完成后自动折叠，详情随时展开。 Long agent tasks, without transcript clutter: focused progress, auto-folded history, details on demand.
- [DietCokewithSugar/dsh-user-experience](https://github.com/DietCokewithSugar/dsh-user-experience) ★5 · `dsh-user-experience` — DeepSeek Harness UX walkthrough plugin: persona-driven source-code UX review for React + TypeScript projects
...
- [chyra-moon/deepseek-harness-desktop](https://github.com/chyra-moon/deepseek-harness-desktop) ★5 · `deepseek-harness-desktop` — DeepSeek Harness desktop shell: 1:1 replica of the official web UI as a Windows desktop app (community project)
...
- [opensetk/dsh-xiaohei](https://github.com/opensetk/dsh-xiaohei) ★4 · `dsh-pet` — dsh的罗小黑插件
- [FlashingChen/dsh-worktree](https://github.com/FlashingChen/dsh-worktree) ★4 · `dsh-worktree` — Codex-style permanent git worktrees for DeepSeek Harness: worktree_create/list/remove agent tools, a /worktree chat command, and durable per-repo manifests.
...
- [wssfk12138/dsh-wechat-notify](https://github.com/wssfk12138/dsh-wechat-notify) ★4 · `dsh-wechat-notify` — DeepSeek Harness 插件：为 agent 新增 wechat_notify 工具，让 AI 通过本机 ClawBot 微信通道主动给你发通知（任务完成 / 需决策时），中文可靠、掉线自提示。
...
- [moxisuki/dsh-lan](https://github.com/moxisuki/dsh-lan) ★4 · `dsh-lan` — DeepSeek Harness（dsh）的局域网插件：一条 overlay 把 dsh web 绑定到局域网，并通过 index tap 注入 crypto.randomUUID    │ polyfill 修复非安全上下文启动崩溃。
...
- [Lixiaoyiao/deepseek-harness-action](https://github.com/Lixiaoyiao/deepseek-harness-action) ★2 · `deepseek-harness-action` — Community GitHub Action for DeepSeek Harness — AI Code Review · CI Diagnosis · Auto Fix · Issue → PR
...
- [liyupi/dsh-kun-like-pet](https://github.com/liyupi/dsh-kun-like-pet) ★1 · `dsh-kun-like-pet` — Kun Like 桌宠 —— DeepSeek Harness 桌面宠物插件：右下角小坤宠随 Agent 工作状态切换 9 种动作，任务完成播放「你干嘛~哎哟」
...
- [suzike/freestyle-dsh-theme](https://github.com/suzike/freestyle-dsh-theme) ★1 · `@linxin666/freestyle-dsh-theme` — DeepSeek Harness 主题体验插件：OKLCH 主题提案 + 主题设计器（跨重启持久化）
...
- [hccccc01333/dsh-excel-chat](https://github.com/hccccc01333/dsh-excel-chat) ★1 · `vera` — dsh-excel-chat — talk to Excel in DeepSeek Harness: create, edit, repair, and verify spreadsheets by conversation (cells, formulas, styles, filters, tables, charts); every edit is auto-validated.
...
- [chenw2759-wq/dsh-easyssh](https://github.com/chenw2759-wq/dsh-easyssh) ★1 · `dsh-easyssh` — 用于远程ssh快速相应，同时可以直接在前端操作/查看远程服务器上的信息与代码。
...
- [william-jin-cmu/dsh-artifact](https://github.com/william-jin-cmu/dsh-artifact) ★1 · `@dsh-external/dsh-artifact` — dsh 插件：文件交付协议——send_artifact 工具经 tool/result meta 携带结构化描述子，任意客户端可渲染
...
- [oceanxuikun/dsh-eva-theme-plugin](https://github.com/oceanxuikun/dsh-eva-theme-plugin) ★0 · `dsh-eva-theme-plugin` — Eva theme style plugin for deepseek harness webui
...
- [KeLearns/dsh-update-checker](https://github.com/KeLearns/dsh-update-checker) ★0 · `@keLearns/dsh-update-checker` — DeepSeek Harness official runtime update checker plugin
...
<details>
<summary><strong>🔁 Workflow & Automation</strong> <sup>109 plugins</sup></summary>

### Workflow & Automation

- [Devin-AXIS/iPolloWork](https://github.com/Devin-AXIS/iPolloWork) ★3788 · `@ipollo/ipollowork-workspace` — A next-generation, source-available AI workspace with a self-evolving agent runtime for editable code, design, presentations, websites, and video—a Codex alternative that integrates DeepSeek Harness for subagent delegation, combining iPolloWork’s complete AI workbench with DSH’s specialized agents and both plugin ecosystems in one workflow.
- [AdamPlatin123/awesome-dsh-plugins](https://github.com/AdamPlatin123/awesome-dsh-plugins) ★575 — 前部索引仓库（Radar）：自动扫描发现的所有 dsh 插件候选；经测试合格的将移入后序精选目录仓库
...
- [LaplaceYoung/oh-my-dsh](https://github.com/LaplaceYoung/oh-my-dsh) ★36 · `oh-my-dsh` — oh-my-dsh：面向 DSH (DeepSeek Harness) 的插件生态——700+ 插件，只通过扩展接缝注册，不修改 agent-loop 骨架
...
- [titanwings/dsh-automation](https://github.com/titanwings/dsh-automation) ★21 · `@dsh-external/dsh-automation` — DSH 自动化插件：让 Coding 任务按计划在全新 Agent Session 中运行，并由用户或 Agent 创建和管理定时任务。 / Run coding tasks in fresh Agent sessions and manage schedules from DSH Web or an Agent.
- [ysr666/dsh-vision-router](https://github.com/ysr666/dsh-vision-router) ★13 · `dsh-vision-router` — DeepSeek Harness 视觉插件：图片自动识图（内置免费视觉模型链）+ 像素级视觉工具（看图问答/定位/裁剪/像素对比/取色/OCR/矢量化/抠图/截图），图片轮可像文本轮一样连续多步调用工具
...
- [Fisfzy/ego-browser](https://github.com/Fisfzy/ego-browser) ★9 · `@dsh-external/ego-browser` — DSH（DeepSeek Harness）插件：把 ego-lite 浏览器（给 AI Agent 用的 Chromium）接入 HARNESS——13 个结构化 ego_* 工具（文本语义快照、语义定位点击、表单填充、截图、CDP 控制、任务空间隔离），内置 ego 运行时，Linux + Chrome 开箱即用，无需克隆官方仓库或手动构建。
...
- [zp-home/dsh-recommend](https://github.com/zp-home/dsh-recommend) ★4 · `dsh-recommend` — DSH 插件生态透明排行与推荐：每日自动抓取 dsh-plugin 话题 + 公开评分模型 + 排行/推荐插件与静态站
...
- [Fisfzy/zotero-harvest](https://github.com/Fisfzy/zotero-harvest) ★4 · `@dsh-external/zotero-harvest` — Zotero 文献采集入库插件（DSH external plugin）：多源检索（OpenAlex/arXiv/Crossref/Europe PMC/Semantic Scholar）+ OA 下载链接解析（Unpaywall）+ 充分性审计 + 入库本地 Zotero + 触发 zotero-wave-rag 重建
...
- [william-jin-cmu/dsh-companion](https://github.com/william-jin-cmu/dsh-companion) ★3 · `cetus` — DeepSeek Harness 的常驻桌面助手：全局唤起、定时自动化、快捷回复、插件市场
...
- [jasonsun29/ds-balance-card](https://github.com/jasonsun29/ds-balance-card) ★1 · `ds-balance-card` — DeepSeek Harness 常驻额度卡片插件:自动识别已配置的平台 API Key,显示余额与 Coding Plan 额度
...
- [Aeanfx/dsh-plugin-dated-folders](https://github.com/Aeanfx/dsh-plugin-dated-folders) ★0 · `dsh-plugin-dated-folders` — 本插件由 DeepSeek Harness AI 完全制作，人工仅辅助操作（账号/上传/2FA 发布）。Tidy by date — every file your agent generates is archived into a YYYY-MM-DD_<topic> folder automatically. One folder per day, zero clutter.

</details>

<a id="tools"></a>
<details>
<summary><strong>🛠️ Tools</strong> <sup>156 plugins</sup></summary>

### Tools

- [paean-ai/deeptide](https://github.com/paean-ai/deeptide) ★1041 · `deeptide` — Built by DeepSeek, for DeepSeek — a Swift-native macOS coding agent
- [ccch1mneyyy/dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) ★595 · `dsh-cc-tui` — 解决DSH 官方尚无终端 TUI 痛点的补位之作，献给偏爱cli的各位极客：Claude Code 风格全屏交互终端插件——像素鲸鱼顶栏、实时工作状态行、思考流式展开、双击 Esc 回滚、上下文进度条 + TPS 仪表。npm 一键安装。
- [morluto/rea](https://github.com/morluto/rea) ★291 · `rea-agents` — Reverse engineer anything with agents, from app behavior down to native binaries.
- [TencentCloud/tencentmeeting-cli](https://github.com/TencentCloud/tencentmeeting-cli) ★88 · `@tencentcloud/tmeet` — 腾讯会议命令行工具（CLI），基于腾讯会议开放平台 OAuth2 授权，支持会议管理、录制管理、参会报告等功能。
- [omdsh-dev/dsh-at-file](https://github.com/omdsh-dev/dsh-at-file) ★80 · `dsh-at-file` — Codex-style @file mentions for DeepSeek Harness: search workspace files in the composer and attach their contents to prompts.
...
- [Lum1104/dsh-browser](https://github.com/Lum1104/dsh-browser) ★61 · `dsh-browser` — dsh plugin: Chrome sidebar extension that lets DSH operate your browser directly—no vision capabilities required.
- [taxueseek/argo](https://github.com/taxueseek/argo) ★61 · `argo-search` — 专门为 agent 打造的 agent 搜索工具，具备多语言搜索能力，覆盖中文/英文/学术/代码/购物/金融/新闻/百科。
...
- [hanelalo/browser-bridge](https://github.com/hanelalo/browser-bridge) ★27 — 让你的agent真的像你一样操控你的浏览器窗口
...
- [libukai/awesome-deepseek-harness](https://github.com/libukai/awesome-deepseek-harness) ★18 — DeepSeek Harness 终极指南：快速入门、资源推荐、精选插件与实用工具 ｜The Ultimate Guide to DeepSeek Harness: QuickStart, Resources, Plugins&Toolkit
...
- [vibeinging/dsh-work](https://github.com/vibeinging/dsh-work) ★15 · `dsh-desktop` — Local-first AI workbench for DSH Plugins, combining Agent sessions, project files, data analysis, web research, MCP, and Office artifacts in an Electron desktop app.
...
- [147228/dsh-xiaoyao-skins](https://github.com/147228/dsh-xiaoyao-skins) ★10 · `@xiaoyao-ai/dsh-xiaoyao-skins` — 夕小瑶 × DeepSeek Harness Web 皮肤合集、安装器与社区创作工具链
...
- [awesome-dsh-plugin/dsh-find-plugin](https://github.com/awesome-dsh-plugin/dsh-find-plugin) ★6 · `dsh-find-plugin` — Find DSH plugins inside the agent — live GitHub dsh-plugin topic search, star-ranked / 会话内搜索发现 DSH 插件
...
- [omdsh-dev/dsh-mnemon](https://github.com/omdsh-dev/dsh-mnemon) ★4 · `dsh-mnemon` — Mnemon 与 DSH 的深度集成插件，为 DSH 提供完备的本地记忆系统：运行时记忆、可检索档案与受监督记忆体。
...
- [dingkaihu63/dsh-robotic-harness](https://github.com/dingkaihu63/dsh-robotic-harness) ★2 · `robotic-harness-dsh` — Robotic Harness: embodied-intelligence research tools for DeepSeek Harness - robot asset inspection, MuJoCo pick-place simulation with fault injection, evidence-based diagnostics, and reproducible experiment bundles.
...
- [Jesse-njx/dsh-cowork](https://github.com/Jesse-njx/dsh-cowork) ★1 · `dsh-cowork` — READ + WRITE for office documents & notebooks in DeepSeek Harness — doc_read/doc_write tools (xlsx, pdf, docx, pptx, ipynb) plus MCP server and CLI
...
- [PerryLink/dsh-composer-history](https://github.com/PerryLink/dsh-composer-history) ★1 · `dsh-composer-history` — Terminal-style input history for the DeepSeek Harness web composer - edge-first arrow keys, draft stashing with exact restore, Esc recovery. A dsh-plugin.
...
- [Ericwong5021/deepseek-plugin-store](https://github.com/Ericwong5021/deepseek-plugin-store) ★1 · `deepseek-plugin-store` — DeepSeek Harness 独立社区插件商店：发现、安装并提交经过验证的插件、工具与扩展。 | Independent community plugin directory.
...
- [nitrazepam01/dsh-web-search-tavily](https://github.com/nitrazepam01/dsh-web-search-tavily) ★0 · `dsh-web-search-tavily` — Tavily-backed web search provider bundle for DeepSeek Harness (dsh) with hot-switchable backend (Tavily / DeepSeek search)
...
- [Youngxj/dsh-ProjectModel](https://github.com/Youngxj/dsh-ProjectModel) ★0 · `dsh-ProjectModel` — deepseek项目组功能
- [egnmosk/dsh-browser-bridge](https://github.com/egnmosk/dsh-browser-bridge) ★0 · `dsh-browser-bridge` — DeepSeek Harness plugin + browser extension bridge: browser_* agent tools (navigate, click, type, screenshot, eval) over a localhost WebSocket — like Kimi WebBridge / Claude's browser extension.
...
<details>
<summary><strong>🔔 Notifications & Monitoring</strong> <sup>23 plugins</sup></summary>

### Notifications & Monitoring

- [hellowind777/helloagents](https://github.com/hellowind777/helloagents) ★669 · `helloagents` — 一个自主的高级智能伙伴，不仅分析问题，更持续工作直到完成实现和验证。
- [NanmiCoder/dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) ★171 · `dsh-agent-teams` — AgentTeams plugin for DeepSeek Harness
...
- [lvyuchuiyi/dsh-funpack](https://github.com/lvyuchuiyi/dsh-funpack) ★2 · `dsh-funpack` — ??????????????????????? DeepSeek Harness ??
...
<a id="dev-helpers"></a>
<details>
<summary><strong>🧑‍💻 Development Helpers</strong> <sup>48 plugins</sup></summary>

### Development Helpers

- [Electricitysheep/dsh-handbook](https://github.com/Electricitysheep/dsh-handbook) ★110 — DeepSeek Harness (dsh) 从 0 到 1 深度手册：安装/插件开发/性能调优/实测案例/同模型多 Agent 实测对比（中文 + 英文 PDF）
- [Alex-Yanggg/awesome-DSH-plugin](https://github.com/Alex-Yanggg/awesome-DSH-plugin) ★42 — A meticulously curated list of useful plugins, extensions, tools and development resources built for DSH, covering productivity enhancement, functional expansion, debugging utilities and custom development modules.
...
- [krislavten/ai-sdk-provider-dsh](https://github.com/krislavten/ai-sdk-provider-dsh) ★1 · `ai-sdk-provider-dsh` — AI SDK provider that drives a DeepSeek Harness (dsh) runtime as a LanguageModelV3 — works on AI SDK v6 and v7
...
- [PerryLink/dsh-output-styles](https://github.com/PerryLink/dsh-output-styles) ★1 · `dsh-output-styles` — Claude Code outputStyles for DeepSeek Harness - session-scoped, durable, runtime-switchable model output styles (/style command, output_style storage domain, systemPrompt injection)
...
<a id="learning"></a>
<details>
<summary><strong>🎓 Learning & Education</strong> <sup>5 plugins</sup></summary>

### Learning & Education

- [hikariming/dshfind](https://github.com/hikariming/dshfind) ★4 · `dshfind` — DSH (DeepSeek Harness) 原理学习、插件市场与最佳实践 · Learn DSH principles, plugin marketplace & best practices
...
<a id="misc"></a>
<details>
<summary><strong>🧩 Miscellaneous</strong> <sup>391 plugins</sup></summary>

### Miscellaneous

- [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) ★75885 · `@deepseek-ai/dsh-root` — DeepSeek Harness: Everything is a Plugin.
- [titanwings/colleague-skill](https://github.com/titanwings/colleague-skill) ★21651 — 将冰冷的离别化为温暖的 Skill，欢迎加入数字生命1.0！Transforming cold farewells into warm skills? It's giving rebirth era. Welcome to Digital Life 1.0. 🫶
- [whiteguo233/OpenBiliClaw](https://github.com/whiteguo233/OpenBiliClaw) ★2193 — 本地私有、开源的自进化跨平台 AI 内容发现 Agent：先理解你，再主动从 B站、小红书、抖音、YouTube、X、知乎、Reddit、微博等平台与开放 Web 寻找内容。（支持 deepseek harness 插件） | Local-first open-source cross-platform AI content discovery agent: understands you, then proactively finds content across Bilibili, Xiaohongshu, Douyin, YouTube, X, Zhihu, Reddit, Weibo and the open web.（support deepseek harness plugin）
- [PicGo/PicGo-Core](https://github.com/PicGo/PicGo-Core) ★963 · `picgo` — :zap:The ultimate image uploading engine. Both CLI & API supports.
- [liustack/modlens](https://github.com/liustack/modlens) ★944 · `@liustack/modlens` — The first vision plugin for DeepSeek Harness, and the vision bridge for every text-only coding agent. Paste an image, get structured JSON evidence (OCR, layout, semantics).
...
- [xyTom/coding-tools-mcp](https://github.com/xyTom/coding-tools-mcp) ★752 — Give any AI agent the ability to code
...
- [awesome-dsh-plugin/awesome-dsh-plugin](https://github.com/awesome-dsh-plugin/awesome-dsh-plugin) ★388 · `awesome-dsh-plugin` — A curated list of plugins for DeepSeek Harness (dsh) · DeepSeek Harness 插件精选列表
- [Small-tailqwq/dsh-deep-whale](https://github.com/Small-tailqwq/dsh-deep-whale) ★345 — DSH Web 鲸鱼娘皮肤系列(深海女仆工坊 maid-atelier)——CC BY-NC-SA 4.0
- [PM-Shawn/Abu-Cowork](https://github.com/PM-Shawn/Abu-Cowork) ★318 · `abu` — Open-source alternative to Claude Cowork — a local-first AI agent desktop app · multi-model · self-evolving skills · privacy-first · multi-Harness roadmap · DeepSeek Harness integration in progress
- [0xsline/awesome-deepseek-harness](https://github.com/0xsline/awesome-deepseek-harness) ★266 — DeepSeek Harness (DSH) ecosystem: curated plugins, tools, and infrastructure from dsh-external/hub and the public dsh-plugin topic.
- [cofy-x/axern](https://github.com/cofy-x/axern) ★265 · `@cofy-x/axern` — Open-source sandboxes for AI agents, untrusted code execution, and durable services.
...
- [vlln/whale-girl](https://github.com/vlln/whale-girl) ★86 · `whale-girl` — DSH Web GUI 桌面宠物插件（QQ 宠物形态）：右下角悬浮、可拖拽/投喂/玩耍的积累型伙伴。官方 repository-plugin（.dsh-plugin 格式），config.yaml 安装：github:dsh-external/whale-girl#<ref>&path:/.dsh-plugin
...
- [bruc3van/awesome-dsh-plugin](https://github.com/bruc3van/awesome-dsh-plugin) ★47 — 用 30 秒找到适合你的 DeepSeek Harness 插件。 不只是仓库列表：这里告诉你插件解决什么问题、适合谁，以及从哪里开始。
...
- [Anionex/dsh-turn-rewind](https://github.com/Anionex/dsh-turn-rewind) ★28 · `@dsh-external/turn-rewind` — deepseek harness对话和代码状态回退插件 | DSH — rewind conversation and workspace state, powered by a persistent Change Ledger
- [forrestchang/dsh-multica-runtime](https://github.com/forrestchang/dsh-multica-runtime) ★27 · `@multica-ai/dsh-runtime` — Support dsh runtime on Multica.
...
- [wess09/DeepSeekHarnessDesktop](https://github.com/wess09/DeepSeekHarnessDesktop) ★15 · `deepseek-harness-desktop` — DeepSeekHarness桌面端打包
...
- [bradeGithub/DSH-Plugins-Marketplace](https://github.com/bradeGithub/DSH-Plugins-Marketplace) ★10 · `dsh-plugin-marketplace` — DSH插件市场 / DSH Plugin Marketplace: 在 DeepSeek Harness Web GUI 中一键浏览、安装与更新 GitHub topic:dsh-plugin 的全部插件 | browse, install & update all GitHub dsh-plugin plugins in the DSH Web GUI
...
- [Ghost011118/dsh-balance-meter](https://github.com/Ghost011118/dsh-balance-meter) ★8 · `dsh-balance-meter` — DeepSeek account balance and session cost readout for the DeepSeek Harness Web GUI
...
- [whyihaveyou/dsh-suite](https://github.com/whyihaveyou/dsh-suite) ★5 · `dsh-suite` — Bilingual curated DeepSeek Harness plugin directory — daily compat CI, create-dsh-plugin scaffold, own plugins.
- [Ychris12138/dsh-usage-stats](https://github.com/Ychris12138/dsh-usage-stats) ★5 · `dsh-usage-stats` — Token usage heatmap, per-model breakdowns, and DeepSeek account balance for the DeepSeek Harness Web GUI (dsh web).
- [HuanLinOTO/dsh-plugin-pet-rs](https://github.com/HuanLinOTO/dsh-plugin-pet-rs) ★5 — DSH 桌宠（Rust 版），5 态鲸鱼 + 双 SSE 实时推送 + 透明置顶窗 + 系统托盘，三端支持 | DSH desktop pet (Rust edition): 5-state whale + dual SSE real-time push + transparent always-on-top window + tray, cross-platform
- [knqiufan/powercontext-dsh](https://github.com/knqiufan/powercontext-dsh) ★5 · `powercontext-dsh` — DeepSeek Harness plugin that connects to a PowerContext Server over HTTP for recall, memory, handoff, experience, and skills.
...
- [Electricitysheep/dsh-tool-turbo](https://github.com/Electricitysheep/dsh-tool-turbo) ★4 · `dsh-tool-turbo` — Per-round reasoning_effort optimizer for DeepSeek Harness (dsh): auto-downgrades tool-call reasoning for simple tool chains, lifting back for heavy work. Cuts thinking time between tool calls.
...
- [Void0312Aurora/dsh-desktop-electron](https://github.com/Void0312Aurora/dsh-desktop-electron) ★3 · `dsh-desktop-electron` — Cross-platform Electron desktop shell for the DSH Web GUI: tray-resident standalone window over your own dsh web, no bundled Node runtime
...
- [unitarylab/quantum-practices](https://github.com/unitarylab/quantum-practices) ★3 · `dsh-unitarylab-quantum-practices` — Quantum Algorithms Best Practices
...
- [weijiafu14/pi2dsh](https://github.com/weijiafu14/pi2dsh) ★2 · `pi2dsh` — Bridge the Pi and DeepSeek Harness ecosystems: one Pi Host ABI runs unmodified Pi extensions as native DSH plugins. 打通 Pi 与 DSH 生态。
...
- [sjscy05/deepseek-harness-vision-plugin](https://github.com/sjscy05/deepseek-harness-vision-plugin) ★2 · `vision-plugin` — vision_read tool: lets the text-only DeepSeek main model read images through a configurable vision sub-model (OpenAI-compatible / Anthropic / Gemini APIs). Scratch plugin for DeepSeek Harness.
...
- [Yihong89/dsh-usage-plugin](https://github.com/Yihong89/dsh-usage-plugin) ★2 · `dsh-plugins` — DeepSeek Harness (DSH) plugins. First: dsh-usage-report — per-session token usage & estimated cost (/usage + usage_report), priced from the DeepSeek pricing table.
...
- [Meredith2328/dsh-sticky-note](https://github.com/Meredith2328/dsh-sticky-note) ★2 · `dsh-sticky-note` — DSH 便签插件：随手记点子/感想/TODO，Markdown 预览 + 快捷键 + 历史归档，存储路径可配置
...
- [Axiaohungry/dsh-llm-codebuddy](https://github.com/Axiaohungry/dsh-llm-codebuddy) ★1 · `dsh-llm-codebuddy` — 在deepseek harness中使用workbuddy api，因为公司只提供workbuddy积分
...
- [FEOH333/dsh-delegate](https://github.com/FEOH333/dsh-delegate) ★1 · `dsh-tool-subagent-model` — dsh-delegate: model-aware subagent delegation for DeepSeek Harness — per-call models, depends_on dependency gating, per-child personas, a durable run roster, audit events, and conversation-flow tool cards. | 给 DeepSeek Harness 的子代理委派加上：按次选模型、依赖门控、角色人设、任务花名册。
- [tc206107/dsh-open-ecosystem](https://github.com/tc206107/dsh-open-ecosystem) ★1
- [sb1733831438-maker/DSH-closerAI](https://github.com/sb1733831438-maker/DSH-closerAI) ★1 · `closerai` — CloserAI - a local-first, model-agnostic, permission-transparent desktop AI workbench built on DeepSeek Harness.
...
- [sopaco/terrain](https://github.com/sopaco/terrain) ★1 · `terrain` — Engineering environment management platform built for the age of AI-assisted development
...
- [white0dew/awesome-dsh-plugins](https://github.com/white0dew/awesome-dsh-plugins) ★1 · `awesome-dsh-plugins` — Awesome DSH Plugins: a public GitHub directory for DeepSeek Harness plugins, DSH plugins, install commands, and ecosystem discovery.
- [121103qwq/dsh-vision-sidecar](https://github.com/121103qwq/dsh-vision-sidecar) ★1 · `dsh-vision-sidecar` — Hosted free vision sidecar for DeepSeek Harness with durable session evidence
...
- [Pheobe-Southwood/dsh-acp-paseo](https://github.com/Pheobe-Southwood/dsh-acp-paseo) ★1 · `dsh-acp-paseo-root` — dsh-acp-paseo monorepo root: dsh (DeepSeek Harness) ⇄ Paseo ACP integration
...
- [ophielel/dsh-devkit](https://github.com/ophielel/dsh-devkit) ★0 · `dsh-devkit-workspace`
...
- [whitelonng/dsh-plugin-describe-image](https://github.com/whitelonng/dsh-plugin-describe-image) ★0 — DeepSeek Harness plugin: describe_image — give a text-only model vision through an OpenAI-compatible VLM endpoint
...
- [akqwpeter-prog/dsh-media-skills](https://github.com/akqwpeter-prog/dsh-media-skills) ★0 · `dsh-media-skills` — 给 DeepSeek Harness 装上「眼睛」和「画笔」：免费视觉模型 + 贴图直读 + 读图/生图 Skill。Free vision model, paste-image reading & generation skills for DeepSeek Harness. 👁️🎨
...
- [arcmosin/dsh-wordbox](https://github.com/arcmosin/dsh-wordbox) ★0 · `dsh-wordbox` — DSH Web GUI常用词箱子，方便项目常用词的存储和粘贴 | DSH Web GUI Common Words Box – for storing and pasting frequently used project terms."
...
Add the [`dsh-plugin`](https://github.com/topics/dsh-plugin) topic to your repository. The hourly crawl will pick it up automatically, so no PR is needed.
